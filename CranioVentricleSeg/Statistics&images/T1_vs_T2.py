...
# Load data. Excel file generated by final_metrics_segmentation.py
...
for s in structures:
    ...
    # Use only paired data --> if CSP is in only 1 case, the value is dropped
    # Only cases in which both the models segmented CSP are kept 
    mask = ~(x.isna() | y.isna())
    ...
    print(f"  Dropped: {n_before - n_after}")       #For CSP 
...
plt.tight_layout()
plt.savefig("boxplot_T1vsT2.png", dpi=300)
plt.show()